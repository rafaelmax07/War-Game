...
class Lista:
    ...
    def checarDuplicidade(self, chave):
        for e in self.__dado:
            if e == chave:
                return True
        # por dedução, a chave não se encontra no "array"
        return False
    ...
    def concatenar(self, outraLista: 'Lista'):
        ''' Essa operação deve criar UMA NOVA LISTA que é o resultado da concontacao dela mesma
           com "outraLista". 
           A nova lista deve ser retornada.'''
        pass
